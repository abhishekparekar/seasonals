...
export default function StoryPage({ onNavigate }) {
  ...
  return (
    <div className="w-full font-inter bg-[#FFFDF9] min-h-screen pb-16">
          ...
          {storyMilestones.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-white rounded-2xl p-5 border border-gray-200 shadow-sm hover:shadow-lg hover:border-[#fdb927]/60 transition-all flex flex-col justify-between group relative overflow-hidden"
              >
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <span className="font-playfair text-2xl font-black text-gray-300 group-hover:text-[#1b072a] transition-colors">
                      {item.chapter}
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5 mb-2">
                    ...
                    <h3 className="font-playfair text-base font-bold text-gray-900 leading-snug">
                      {item.title}
                    </h3>
                  </div>
      ...
      <section className="w-full px-3.5 sm:px-6 lg:px-8 pt-10">
        <div className="bg-gradient-to-r from-[#1b072a] via-[#2c0d45] to-[#1b072a] text-white rounded-3xl p-6 sm:p-10 border-2 border-[#fdb927]/40 shadow-2xl relative overflow-hidden text-center">
          <Quote className="w-12 h-12 text-[#fdb927]/15 absolute top-4 left-6 pointer-events-none" />
          
          <div className="relative z-10 max-w-3xl mx-auto space-y-3">
            <span className="text-xs font-extrabold text-[#fdb927] uppercase tracking-wider block">
              The Seasonals Core Philosophy
            </span>
            <h2 className="font-playfair text-2xl sm:text-3xl md:text-4xl font-bold leading-tight text-white">
      ...
      <section className="w-full px-3.5 sm:px-6 lg:px-8 pt-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
          {coreValues.map((val, idx) => (
            <div
              key={idx}
              className="bg-white p-5 rounded-2xl border border-gray-200 hover:border-[#fdb927] shadow-sm hover:shadow-md transition-all"
            >
              <div className="w-8 h-8 rounded-lg bg-[#fdb927]/20 text-[#1b072a] flex items-center justify-center font-bold text-sm mb-3">
                0{idx + 1}
              </div>
      ...
      {/* 5. Direct CTA */}
      <section className="w-full px-3.5 sm:px-6 lg:px-8 pt-14">
        <div className="bg-[#FFF8EB] rounded-3xl p-6 sm:p-8 border-2 border-[#fdb927]/50 shadow-md text-center max-w-3xl mx-auto space-y-4">
          <h3 className="font-playfair text-xl sm:text-2xl font-bold text-[#1b072a]">
          ...
          <div className="pt-2 flex flex-wrap items-center justify-center gap-3">
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#1b072a] hover:bg-[#2c0d45] text-[#fdb927] font-black text-xs sm:text-sm px-7 py-3 rounded-full shadow-lg hover:scale-105 transition-all cursor-pointer"
            >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-[#fdb927] hover:bg-[#ffc84a] text-[#1b072a] font-bold text-xs sm:text-sm px-6 py-3 rounded-full shadow-md hover:scale-105 transition-all cursor-pointer"
            >
